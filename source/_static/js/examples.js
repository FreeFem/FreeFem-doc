...
updateList = (editor) => {
   ...
   all_examples.forEach(function callback(example, i) {
      if (filtered_examples[i] && filtered_examples_keyword[i]) {
         ...
         exi.innerHTML = '<a href="#" title="example.desc" id="'+example.name+'" onclick="loadExamplefromGitHub(\''+example.name+'\',\''+example.dir+'\', editor)"> '+ example.name +'</a><br>'
...
let treedata =
[
{ "id": "0", "text": "Equations", "children":
  [
  { "id": "0-0", "text": "Fluid mechanics", "children":
    [
    { "id": "Stokes", "text": "Stokes" },
    { "id": "Navier-Stokes", "text": "Navier-Stokes" }
    ]
  },
  { "id": "0-1", "text": "Solid mechanics", "children":
    [
...
{ "id": "2", "text": "Mesh adaptation", "children":
  [
