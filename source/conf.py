...
version = "4.13"  # GitHubVersion['tag_name']
# The full version, including alpha/beta/rc tags
release = "4.13"  # GitHubVersion['tag_name']
...
latex_additional_files = [
    "_static/img/logo_ANR.png",
    "_static/img/logo_CNRS.png",
    "_static/img/logo_INRIA.png",
    "_static/img/logo_LJLL.png",
    "_static/img/logo_Sorbonne.png",
    "_static/img/logo_UPMC.png",
]
...
latex_documents = [
    (master_doc, "FreeFEM.tex", "FreeFEM Documentation", "Frederic Hecht", "manual"),
]
...
man_pages = [(master_doc, "freefem", "FreeFEM Documentation", [author], 1)]
