...
A numerical result is given on Fig. 3.13 and the FreeFem++ script is
...
```
$\codered$ **see 3.13 header"computed by"**

|Fig. 3.13: Pressure for a Euler flow around a disk at Mach 2 computed by (3.11)|
|:----|
